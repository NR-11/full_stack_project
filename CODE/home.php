...
if ($category) {
    $query = "SELECT * FROM articles WHERE Category_id = '$category' ORDER BY Article_id DESC";
} else {
...
if (isset($_GET['search'])) {
    $search = $_GET['search'];
    if ($category) {
        $query = "SELECT * FROM articles WHERE (Title LIKE '%$search%' OR Content LIKE '%$search%') AND Category_id = '$category' ORDER BY Article_id DESC";
    } else {
        $query = "SELECT * FROM articles WHERE Title LIKE '%$search%' OR Content LIKE '%$search%' ORDER BY Article_id DESC";
    }
}
