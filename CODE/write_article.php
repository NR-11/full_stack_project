...
if (isset($_POST['article_title']) && isset($_POST['upload']) && isset($_POST['article_content']) && isset($_POST['category'])) {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === 0) {
        ...
        if (move_uploaded_file($_FILES['image']['tmp_name'], $image_path)) {
            $upload_article = "INSERT INTO articles (Title, Content, Image , Category_id) 
                               VALUES ('$article_title', '$article_content', '$image_path', '$category')";
